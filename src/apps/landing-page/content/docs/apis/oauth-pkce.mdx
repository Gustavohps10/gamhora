...
3. Redirecionamento Web
   ...
   │ https://mr-tickapp.com.br/oauth/callback?code=AUTH_CODE&state=STATE
   ▼
...
export default class DiscordOAuthAddon implements IAddon {
  ...
  public async handleLogin(context: AddonContext): Promise<void> {
    ...
    const REDIRECT_URI =
      process.env.MR - TICK_OAUTH_REDIRECT_URI ||
      'http://localhost:3000/oauth/callback' // Em produção: https://mr-tickapp.com.br/oauth/callback
