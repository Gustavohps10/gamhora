...
- **Tarefa de Contingência (`createFallback`)**: Quando o usuário inicia o cronômetro sem selecionar uma tarefa previamente, o Pandhora cria automaticamente uma _General Task_ de contingência para que nenhum segundo trabalhado seja perdido.
