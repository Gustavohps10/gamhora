---
title: Themes
description: Como criar temas visuais personalizados, paletas de cores e estilos para a interface do Metric.
---

# Themes (Temas & Customização Visual)

Os addons da categoria **Themes** permitem personalizar completamente a estética visual do Metric — definindo paletas de cores para modos Claro (Light) e Escuro (Dark), contrastes, bordas e tipografia.

O Metric adota o padrão de design system baseado em **Tokens CSS** (compatível com Tailwind CSS e shadcn/ui), tornando a criação de novos temas simples e declarativa.
...
## ⚙️ Como o Metric Aplica os Temas

1. Quando o usuário seleciona o tema nas preferências do Metric, o Core injeta dinamicamente as variáveis CSS na raiz do DOM (`:root` ou classe `.dark`).
